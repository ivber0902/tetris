...
//					log.Printf("Player State %d (IP: %s) reading: Web socket closed by client", player.id, player.ip)
//					return
//				}
//			case *json.SyntaxError:
//				log.Printf("Player State %d (IP: %s) reading: JSON Unmarshal error: %v", player.id, player.ip, err)
//			case error:
//				log.Printf("Player State %d (IP: %s) reading: JSON reading error: %v", player.id, player.ip, err)
//				return
//			}
//
//		} else {
