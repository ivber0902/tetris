 ...
 */
final class Version20240626133401 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE player (user_id INT DEFAULT NULL, max_score INT DEFAULT NULL, average_score INT DEFAULT NULL, total_score INT DEFAULT NULL, game_count INT DEFAULT NULL, win_count INT DEFAULT NULL, id INT AUTO_INCREMENT NOT NULL, UNIQUE INDEX UNIQ_98197A65A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
